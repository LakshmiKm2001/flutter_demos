    ...
    return Scaffold(
      bottomNavigationBar: SizedBox(
        ...
        child: BottomNavigationBar(
          ...
          selectedItemColor: Color.fromARGB(255, 54, 4, 62),
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
              ListTile(
                title: Text("Hello, User",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 23,color: Colors.purple),),
                subtitle: Text(
                  "Find Hotels Here",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),
                ),
              trailing: IconButton(onPressed: (){}, icon: Icon(Icons.person,color: Colors.purple,),iconSize: 30,)
              ),
              Padding(
                ...
                child: OutlineSearchBar(
                  ...
                  backgroundColor: Color.fromARGB(255, 229, 197, 235),
                ),
              ),
              Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext, index) => Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              decoration: BoxDecoration(color:Color.fromARGB(255, 206, 136, 218)),
                              height: 150,
                              child: Stack(
                                children: [
                                  Image(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Icon(
                      Icons.star_outline,
                      color: Color.fromARGB(255, 121, 16, 140),
                    ),
                  ],
                ),
              ),
