...
class PhoneList extends StatelessWidget{
  ...
  var color=[Colors.green,Colors.red,Colors.blue,Colors.yellow,Colors.purple];
  var phoneimg=<String>
      ...
      body: ListView.builder(
        ...
        return Card(
          ...
          child:ListTile(
               leading: Container(
                width: 80,                                                                                                                                      
                decoration: BoxDecoration(image: DecorationImage(image:NetworkImage(phoneimg[index])
              ),
            ),
          ),
           title: Padding(
